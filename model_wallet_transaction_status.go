...
const (
	INITIATED WalletTransactionStatus = "INITIATED"
	EXECUTED WalletTransactionStatus = "EXECUTED"
	BLOCKED WalletTransactionStatus = "BLOCKED"
	FAILED WalletTransactionStatus = "FAILED"
)

// All allowed values of WalletTransactionStatus enum
