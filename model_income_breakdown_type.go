...
const (
	BONUS IncomeBreakdownType = "bonus"
	OVERTIME IncomeBreakdownType = "overtime"
	REGULAR IncomeBreakdownType = "regular"
	NULL IncomeBreakdownType = "null"
)

// All allowed values of IncomeBreakdownType enum
