...
const (
	CREDIT_CARD CreditAccountSubtype = "credit card"
	PAYPAL CreditAccountSubtype = "paypal"
	ALL CreditAccountSubtype = "all"
)

// All allowed values of CreditAccountSubtype enum
