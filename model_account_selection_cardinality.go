...
const (
	SINGLE_SELECT AccountSelectionCardinality = "SINGLE_SELECT"
	MULTI_SELECT AccountSelectionCardinality = "MULTI_SELECT"
	ALL AccountSelectionCardinality = "ALL"
)

// All allowed values of AccountSelectionCardinality enum
