...
const (
	NULL TransferSweepStatus = "null"
	UNSWEPT TransferSweepStatus = "unswept"
	SWEPT TransferSweepStatus = "swept"
	REVERSE_SWEPT TransferSweepStatus = "reverse_swept"
)

// All allowed values of TransferSweepStatus enum
