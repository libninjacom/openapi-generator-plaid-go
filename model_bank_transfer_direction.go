...
const (
	OUTBOUND BankTransferDirection = "outbound"
	INBOUND BankTransferDirection = "inbound"
	NULL BankTransferDirection = "null"
)

// All allowed values of BankTransferDirection enum
