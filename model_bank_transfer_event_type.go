...
const (
	PENDING BankTransferEventType = "pending"
	CANCELLED BankTransferEventType = "cancelled"
	FAILED BankTransferEventType = "failed"
	POSTED BankTransferEventType = "posted"
	REVERSED BankTransferEventType = "reversed"
)

// All allowed values of BankTransferEventType enum
