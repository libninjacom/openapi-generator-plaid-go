...
const (
	HIGH IncomeVerificationPrecheckConfidence = "HIGH"
	LOW IncomeVerificationPrecheckConfidence = "LOW"
	UNKNOWN IncomeVerificationPrecheckConfidence = "UNKNOWN"
)

// All allowed values of IncomeVerificationPrecheckConfidence enum
