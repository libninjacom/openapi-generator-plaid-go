...
const (
	STATUS_USER_PRESENCE_REQUIRED VerificationRefreshStatus = "VERIFICATION_REFRESH_STATUS_USER_PRESENCE_REQUIRED"
	SUCCESSFUL VerificationRefreshStatus = "VERIFICATION_REFRESH_SUCCESSFUL"
	NOT_FOUND VerificationRefreshStatus = "VERIFICATION_REFRESH_NOT_FOUND"
)

// All allowed values of VerificationRefreshStatus enum
